...
export function LangSelector(props) {
  ...
  return (
    ...
    >
      ...
      <Listbox.Button className="flex h-6 px-2 text-sm items-center justify-center rounded-lg shadow-md shadow-black/5 ring-1 ring-black/5 dark:bg-slate-700 dark:ring-inset dark:ring-white/5 text-gray-500 dark:text-gray-400">
